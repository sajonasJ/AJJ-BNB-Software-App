...
def create_button(image, command, x, y, w, h):
    button = Button(image=image, borderwidth=0, highlightthickness=0, command=command, relief="flat")
    button.place(x=x, y=y, width=w, height=h)
    return button


def create_canvas(window, show_suburb, show_cleanliness, show_price, show_search, show_listings):
    ...
    n = 79
    y_start = 223.0  # This is your starting y value
    x_start = 33.0  # Define an x value if needed
    w = 126.0
    h = 56.0
